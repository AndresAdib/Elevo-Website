    ...
    return (
        <div className='terms'>
            <div className='term-menu'>
               <a href="#header" onClick={() => onClose()}><img src='/src/assets/ELEVOlogo-white.png' alt="" /></a> 
            </div>
            <div className='terms-container'>
                ...
                <p>We are Elevo (“Company,” “we,” “us,” “our“).</p>
                <p>We operate the website https://elevo-advisors.com. (the “Site“), as well as any other related products and services that refer or link to these legal terms (the “Legal Terms“) (collectively, the “Services“).</p>
                <p>You can contact us by phone at (440) 522-0599, email at nyork@elevo-advisors.com</p>
                <p>These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you“), and Elevo, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
                ...
                <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: nyork@elevo-advisors.com. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
                ...
                <p>These Legal Terms shall be governed by and defined following the laws of Mexico. Transom Mexico and yourself irrevocably consent that the courts of Mexico shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.</p>
                ...
                <p>Any dispute arising out of or in connection with these Legal Terms, including any question regarding its existence, validity, or termination, shall be referred to and finally resolved by the International Commercial Arbitration Court under the European Arbitration Chamber (Belgium, Brussels, Avenue Louise, 146) according to the Rules of this ICAC, which, as a result of referring to it, is considered as the part of this clause. The number of arbitrators shall be __________. The seat, or legal place, or arbitration shall be Mexico. The language of the proceedings shall be __________. The governing law of these Legal Terms shall be substantive law of Mexico.</p>
                <h4>Restrictions</h4>
                ...
                <h3>18. CALIFORNIA USERS AND RESIDENTS</h3>
                ...
                <h4>Elevo</h4>
                <h4>Phone: 440-522-0599</h4>
                <h4>nyork@elevo-advisors.com</h4>
            </div>
            <div className='term-menu'>
               <a href="#header" onClick={() => onClose()}><img src='/src/assets/ELEVOlogo-white.png' alt="" /></a> 
            </div>
